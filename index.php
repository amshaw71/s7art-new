...
if($_SERVER['REQUEST_METHOD']=='POST'){
	...
	if(empty($_POST['namelast'])){
		...
		$linktexterr = 'Only letters, white space and punctuation allowed';
		}
		}
...
if ($id>0){
	...
	if($result === false) {
		...
		while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
			if ($auth==true){
				echo "<span class='text-nowrap'><a href='index.php?incr=" . $row['userlinkid'];
	...
	echo "<a href='#join_form' id='join_pop' target='_self'>Add your own links here - Make a new S7ARTID</a>\n";
	echo "<a href='#login_form' id='login_pop' target='_self'>Login</a><br></p>\n";
}
?>
  </div>
</div>
...
<div class="row row-eq-height container-fluid">
  <div class="col-xs-12 col-sm-10 col-sm-offset-1 col-md-10 col-md-offset-1 col-lg-8 col-lg-offset-2">
    ...
    <a href="http://www.ebay.com.au">eBay</a>
    <a href="http://www.egpcapital.com.au/">EGP</a>
    ...
    <a href="http://www.qantas.com/">Qantas</a>
    ...
    <h4>Real Estate</h4>
    <p>
    <a href="http://www.century21.com.au/">Century 21</a>
    ...
    <a href="https://www.corelogic.com.au/">CoreLogic</a>
    <a href="http://www.firstnational.com.au/">FN</a>
    <a href="http://www.harcourts.com.au/">Harcourts</a>
	<a href="http://www.knightfrank.com.au/">Knight Frank</a>
	...
	<a href="https://www.rabobank.com.au">Rabobank</a>
    ...
    <a href="http://www.vodafone.com.au/">Vodafone</a>
...
if(!$result){die("OOps.. Suggestion Counter Broken...");}
echo"$num_rows" . " ";
...
$result=db_query("INSERT INTO pageloads 
(userid,loadtime,referringpage,sessionid,ipaddress,proxiedaddress,HTTP_USER_AGENT) VALUES 
($id,FROM_UNIXTIME($requesttime),'$referringpage','$phpsessid','$ipaddress','$pipaddress','$httpuseragent')");
if(!$result){echo "<h6>The query failed..." . $result . "</h6>";}
?>
 </div>
</div>
...
<!-- ******** popup form - login ********  -->
		...
		if($id<1){
			...
			echo "		<div>\n";
			echo "			<label for='id'>S7artID</label>\n";
