...
$msg1.="<h3>Current Rostered Shifts</h3>\n";
$msg1.="<p></p>\n";
echo $msg1;
echo $msg;
$msg='';
// ******** Query database for shift data, test and display ********
$result=db_select("SELECT shiftindex, shiftendtime, shiftstarttime FROM shifts WHERE staffid='$staffid' ORDER BY shiftstarttime");
$msg.="</p>";
if(!$result){ $msg.= "   <p>Couldn't find any existing shifts to display...</p>\n<br><br>"; }else{
	foreach($result as $value){
